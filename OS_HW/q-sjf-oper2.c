...
//            printf("arr[%d] = %d\n",i,arr[i]);
    ...
    int update(int inter_t,int *s1,int *s2,int *s3,int *gap,int ss1,int ss2,int ss3,int *tit,int arr[],Queue *q1,Queue *q2,Queue *q3)
    {
...
//        printf("i=%d\n",(unsigned)(-1)>>1);
        ...
        update(100, &s1, &s2, &s3, &gap, ss1, ss2, ss3, &tit, arr, q1, q2, q3);
        AddQ(q1, 200,"E",0);
